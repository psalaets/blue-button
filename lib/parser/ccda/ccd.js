...
var exportCCD = function (version) {
  ...
  var mental_status_section = require("./sections/mental_status").mentalStatusSection(version)[0];
  var assessment_section = require("./sections/assessment").assessmentSection(version);
  ...
  var chief_complaint_section = require("./sections/chief_complaint").chiefComplaintSection(version);
  var instructions_section = require("./sections/instructions").instructionsSection(version);
  var physical_exam_section = require("./sections/physical_exam").physicalExamSection(version);
  ...
  return component.define("CCD")
    .fields([
      ...
      ["physicalExam", "1..1", physical_exam_section.xpath(), physical_exam_section]
    ]);
};
