...
var exportEncountersSection = function (version) {
  ...
  var problemObservation = component.define("problemObservation")
    ...
    .fields([
      ...
      ["date_time", "1..1", "h:effectiveTime", shared.EffectiveTime],
      // one and only one of these value properties should exist
      ["value_cd", "0..1", "h:value[@xsi:type='CD']/@displayName"],
      ["value_ed", "0..1", "h:value[@xsi:type='ED']", shared.TextWithReference],
    ...
    .cleanupStep(function normalizeValue() {
      if (this.js) {
        if (this.js.value_cd) {
          this.js.value = this.js.value_cd;
        } else if (this.js.value_ed) {
          this.js.value = this.js.value_ed;
        }

        delete this.js.value_cd;
        delete this.js.value_ed;
      }
    });
