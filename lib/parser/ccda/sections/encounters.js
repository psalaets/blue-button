...
var exportEncountersSection = function (version) {
  ...
  var scaleObservation = component.define("scaleObservation")
    ...
    .fields([
      ...
      ["author", "0..*", "h:author", scaleObservationAuthor],
      ["observation", "0..*", "h:entryRelationship[@typeCode='COMP']/h:observation", supportingObservation],
      ["range", "0..*", "h:referenceRange", scaleObservationReferenceRange],
    ]);
  ...
  var problemObservation = component.define("problemObservation")
    ...
    .fields([
      ...
      ["diagnosisDate", "0..*", "h:entryRelationship[@typeCode='COMP']/h:act", dateOfDiagnosisAct]
    ])
