...
var generateComponents = function (version) {
  ...
  return {
    ...
    ccda_mental_status: require("./ccda/sections/mental_status").mentalStatusSection(version),
    ccda_assessment: require("./ccda/sections/assessment").assessmentSection(version),
    ccda_subjective: require("./ccda/sections/subjective").subjectiveSection(version),
    ccda_objective: require("./ccda/sections/objective").objectiveSection(version),
    ccda_chief_complaint: require("./ccda/sections/chief_complaint").chiefComplaintSection(version),
    ccda_instructions: require("./ccda/sections/instructions").instructionsSection(version)[0],
    ccda_physical_exam: require("./ccda/sections/physical_exam").physicalExamSection(version)[0],
    ...
    ccda_nutrition_entry: require("./ccda/sections/nutrition").nutritionSection(version)[1],
    ...
    ccda_mental_status_entry: require("./ccda/sections/mental_status").mentalStatusSection(version)[1],
    ccda_assessment_entry: require("./ccda/sections/assessment").assessmentSection(version)[1],
    ccda_subjective_entry: require("./ccda/sections/subjective").subjectiveSection(version)[1],
    ccda_objective_entry: require("./ccda/sections/objective").objectiveSection(version)[1],
    ccda_chief_complaint_entry: require("./ccda/sections/chief_complaint").chiefComplaintSection(version),
    ccda_interventions_entry: require("./ccda/sections/interventions").interventionsSection(version)[1],
    ccda_instructions_entry: require("./ccda/sections/instructions").instructionsSection(version)[1],
    ccda_physical_exam_entry: require("./ccda/sections/physical_exam").physicalExamSection(version)[1],
